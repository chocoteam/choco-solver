...
Current stable version is 4.0.5 (28 Sep 2017).
...
Choco-solver is distributed under BSD 3-Clause License (Copyright (c) 1999-2017, Ecole des Mines de Nantes).
...
[tarball](https://github.com/chocoteam/choco-solver/releases/download/4.0.5/choco-4.0.5.zip) which contains
...
The name of the jar file terms the packaging: `choco-solver-4.0.5-with-dependencies.jar` or `choco-solver-4.0.5.jar`.
