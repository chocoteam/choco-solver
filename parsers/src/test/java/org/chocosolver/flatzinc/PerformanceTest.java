...
public class PerformanceTest {
    ...
    public void test_lot_sizing_cp_pigment15b() throws SetUpException {
        ...
        Assert.assertEquals(fzn.getModel().getSolver().getNodeCount(), 1076378, "Unexpected number of nodes");
        Assert.assertEquals(fzn.getModel().getSolver().getFailCount(), 1076309, "Unexpected number of failures");
    }
    ...
    public void test_steiner_tree_es10fst03() throws SetUpException {
        ...
        Assert.assertEquals(fzn.getModel().getSolver().getNodeCount(), 88_026, "Unexpected number of nodes");
        Assert.assertEquals(fzn.getModel().getSolver().getFailCount(), 88_023, "Unexpected number of failures");
    }
