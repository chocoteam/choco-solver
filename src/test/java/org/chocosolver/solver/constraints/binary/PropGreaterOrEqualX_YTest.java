 ...
 * @since 31/10/2018.
 */
public class PropGreaterOrEqualX_YTest {
    ...
    public void testXisPivot() {
        ...
        PropGreaterOrEqualX_Y prop = new PropGreaterOrEqualX_Y(new IntVar[]{x, y});
        // root domains
        ...
        // expected domain
        IntIterableRangeSet oE = new IntIterableRangeSet(-999,9);
        IntIterableRangeSet pE = new IntIterableRangeSet(10,999);
    ...
    private void checkWhenXisPivot(PropGreaterOrEqualX_Y prop,
    ...
    public void testYisPivot() {
        ...
        IntIterableRangeSet pE = new IntIterableRangeSet(-999,30);

        checkWhenYisPivot(prop, x, oR, oD, oE, y, pR, pE);
        pR.remove(12);
        pE.remove(12);
        checkWhenYisPivot(prop, x, oR, oD, oE, y, pR, pE);
    }

    private void checkWhenYisPivot(PropGreaterOrEqualX_Y prop,
                                   IntVar o, IntIterableRangeSet oR, IntIterableRangeSet oD, IntIterableRangeSet oE,
                                   IntVar p, IntIterableRangeSet pR, IntIterableRangeSet pE) {
        ExplanationForSignedClause expl = Mockito.mock(ExplanationForSignedClause.class);
        ValueSortedMap front = Mockito.mock(ValueSortedMap.class);
