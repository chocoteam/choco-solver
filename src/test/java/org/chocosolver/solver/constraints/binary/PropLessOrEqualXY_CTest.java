 ...
 * @since 31/10/2018.
 */
public class PropLessOrEqualXY_CTest {
    ...
    public void testXisPivot() {
        ...
        PropLessOrEqualXY_C prop = new PropLessOrEqualXY_C(new IntVar[]{x, y},5);
        // root domains
        ...
        IntIterableRangeSet pE = new IntIterableRangeSet(-999,-5);
    ...
    private void check(PropLessOrEqualXY_C prop,
