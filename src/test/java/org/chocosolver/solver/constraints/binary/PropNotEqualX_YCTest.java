 ...
 * @since 31/10/2018.
 */
public class PropNotEqualX_YCTest {

    @Test(groups = "1s", timeOut = 60000)
    public void testXpivot() {
        Model mo = new Model();
        IntVar x = mo.intVar("x", -999, 999);
        IntVar y = mo.intVar("y", -999, 999);
        PropNotEqualX_YC prop = new PropNotEqualX_YC(new IntVar[]{x, y}, 5);
        // root domains
        ...
        checkxPivot(prop, x, oR, oD, oE, y, pR, pE);
    }

    @Test(groups = "1s", timeOut = 60000)
    public void testYpivot() {
        Model mo = new Model();
        IntVar x = mo.intVar("x", -999, 999);
        IntVar y = mo.intVar("y", -999, 999);
        PropNotEqualX_YC prop = new PropNotEqualX_YC(new IntVar[]{x, y}, 5);
        ...
        checkxPivot(prop, y, oR, oD, oE, x, pR, pE);
    }

    private void checkxPivot(PropNotEqualX_YC prop,
