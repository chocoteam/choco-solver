...
public class PropTableStr2 extends Propagator<IntVar> {
	...
	class str2_var {
		...
		IntVar var;			/** original var */
		int indice;			/** index in the table */
		IStateInt last_size;/** Numerical reversible of the last size */
		BitSet GAC_Val; 	/** at each step, it will say if the value is GAC */
		int nb_consistant;	/** count the number of consistant value */
		TreeMap<Integer,Integer> index_map;/** contains all the value of the variable */
