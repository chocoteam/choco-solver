...
public class PropBinPacking extends Propagator<IntVar> {
    ...
    protected void removeItemFromBin(int binIdx, int itemIdx) throws ContradictionException {
    ...
    protected boolean singleItemEliminationAndCommitment(int j) throws ContradictionException {
    ...
    protected void processBin(int j) throws ContradictionException {
