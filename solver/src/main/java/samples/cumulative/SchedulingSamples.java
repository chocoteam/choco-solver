...
public class SchedulingSamples {
	...
	public static void main(String[] args) {
		...
		while ( pb != null ) {
			//chk.pack(pb.n, pb.capacity, pb.ls, pb.us, pb.d, pb.d, pb.le, pb.ue, pb.h);
			//chk.classic(pb.n, pb.capacity, pb.ls, pb.us, pb.d, pb.d, pb.le, pb.ue, pb.h);
			//chk.greedy(pb.n, pb.capacity, pb.ls, pb.us, pb.d, pb.d, pb.le, pb.ue, pb.h);
			chk.dynamic(pb.n, pb.capacity, pb.ls, pb.us, pb.d, pb.d, pb.le, pb.ue, pb.h);
			pb = p.nextInstance();
		}
        */
		...
		while (nbInstances > 0) {
			...
			chk = new Builder(false,false,false,timeout,"minsize");
			//chk.classic(pb.n, pb.capacity, pb.ls, pb.us, pb.d, pb.d, pb.le, pb.ue, pb.h);
			chk.dynamic(pb.n, pb.capacity, pb.ls, pb.us, pb.d, pb.d, pb.le, pb.ue, pb.h);
			//chk.greedy(pb.n, pb.capacity, pb.ls, pb.us, pb.d, pb.d, pb.le, pb.ue, pb.h);
			nbInstances--;
		...
		Constraint c = new Cumulative(starts, durations, ends, heights, limit, solver, Type.DYNAMIC_SWEEP);
		solver.post(c);
	...
	public static class OneFileFilter implements FilenameFilter {
		...
		public boolean accept(File arg0, String arg1) {
			if (arg1.startsWith("csched-") && arg1.endsWith(".dat")) return true;
			return false;
		}
	}
