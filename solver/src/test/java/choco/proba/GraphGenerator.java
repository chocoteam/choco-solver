...
public class GraphGenerator {
    ...
    /**
     * randomly generate a boolean matrix representing a connected undirected graph
     *
     * @param nbEdges the total number of edges in the graph
     * @return a boolean matrix
     */
    public boolean[][] edgeBasedGenerator(int nbEdges) {
        int cur = 0;
        for (int i = 0; i < size; i++) {
        ...
        nbEdges  = nbEdges - cur;
        //System.out.println("remaing edges to affect: "+nbEdges);
        while (nbEdges > 0) {
    ...
    private void generateInitialTree() {
        ...
        //System.out.println("generate a tree " + this);
    }
