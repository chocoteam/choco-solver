 ...
 * @since 31/03/2021
 */
public class TestSubgraphExcludeNodesView {
    ...
    public void testInstantiateAndGenerate() {
        ...
        UndirectedGraphVar g2 = m.subgraphExcludeNodesView(g, SetFactory.makeConstantSet(new int[]{0, 4}));
    ...
    public void testInstantiate() {
        ...
        UndirectedGraphVar g2 = m.subgraphExcludeNodesView(g, excluded);
