 ...
 * @since 31/03/2021
 */
public class TestDirectedSubgraphInducedByNodesView {
    ...
    public void testInstantiateAndGenerate() {
        ...
        DirectedGraphVar g2 = m.subgraphInducedByNodesView(g, SetFactory.makeConstantSet(new int[]{0, 1, 2}));
    ...
    public void testConstrained() {
        ...
        DirectedGraphVar g2 = m.subgraphInducedByNodesView(g, nodes);
