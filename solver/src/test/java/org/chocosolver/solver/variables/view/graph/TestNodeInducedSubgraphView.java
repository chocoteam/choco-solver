 ...
 * @since 31/03/2021
 */
public class TestNodeInducedSubgraphView {
    ...
    public void testInstantiateAndGenerate() {
        ...
        UndirectedGraphVar g2 = m.nodeInducedSubgraphView(g, SetFactory.makeConstantSet(new int[]{0, 1, 2}), false);
    ...
    public void testConstrained() {
        ...
        UndirectedGraphVar g2 = m.nodeInducedSubgraphView(g, nodes, false);
