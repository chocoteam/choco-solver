...
/**
 * Test class for the forest graph constraint.
 * The test is identical to acyclic constraint tree for undirected graphs as forest constraint only relies on
 * PropAcyclic, but exists in cas the forest constraint is implemented with another propagator in the future.
...
public class ForestTest {
    ...
    public void undirectedGenerateTest() {
        ...
        Constraint cons = model2.forest(g2);
        int count = 0;
