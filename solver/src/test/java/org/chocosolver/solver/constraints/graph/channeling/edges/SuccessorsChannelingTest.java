...
/**
 * Test class for successorsChanneling graph constraints
 * @author Dimitri Justeau-Allaire
 * @since 23/03/2021
 */
public class SuccessorsChannelingTest {
    ...
    public void testSuccessorsSetsChannelingGenerate() {
        ...
        model.successorsChanneling(g, sets).post();
        while (model.getSolver().solve()) {
            for (int i : g.getValue().getNodes()) {
                int[] gNodes = g.getValue().getSuccessorsOf(i).toArray();
    ...
    public void testSuccessorsSetsChannelingGenerateConstrained() {
        // Generate all solutions
        Model model = new Model();
        int n = 5;
        DirectedGraph LB = GraphFactory.makeStoredDirectedGraph(model, n, setType, setType);
        ...
        while (model.getSolver().solve()) {
            ...
            Assert.assertTrue(g.getValue().getSuccessorsOf(0).contains(3));
            Assert.assertFalse(g.getValue().getSuccessorsOf(0).contains(1));
            Assert.assertTrue(g.getValue().getSuccessorsOf(1).size() > 0
                && g.getValue().getSuccessorsOf(1).size() <= 3);
        }
        long nbSolutions = model.getSolver().getSolutionCount();
        // Generate without constraint and check
        model = new Model();
        ...
        while (model.getSolver().solve()) {
            if (g.getValue().getNodes().contains(0)
                    && g.getValue().getSuccessorsOf(0).contains(3)
                    && !g.getValue().getSuccessorsOf(0).contains(1)
                    && g.getValue().getSuccessorsOf(1).size() > 0
                    && g.getValue().getSuccessorsOf(1).size() <= 3) {
                count++;
            }
        }
    ...
    public void testSuccessorsBoolsChannelingGenerate() {
        ...
        model.successorsChanneling(g, boolVars).post();
        while (model.getSolver().solve()) {
            for (int i : g.getValue().getNodes()) {
                int[] gNodes = g.getValue().getSuccessorsOf(i).toArray();
    ...
    @Test(groups="1s", timeOut=60000)
    public void testSuccessorsBoolsChannelingGenerateConstrained() {
        // Generate all solutions
        Model model = new Model();
        int n = 5;
        DirectedGraph LB = GraphFactory.makeStoredDirectedGraph(model, n, setType, setType);
    ...
    @Test(groups="1s", timeOut=60000)
    public void testSuccessorsSetChannelingGenerate() {
        // Generate all solutions
        Model model = new Model();
        int n = 5;
        DirectedGraph LB = GraphFactory.makeStoredDirectedGraph(model, n, setType, setType);
        ...
        model.successorsChanneling(g, set, 0).post();
        while (model.getSolver().solve()) {
            int[] gNodes = g.getValue().getSuccessorsOf(0).toArray();
    ...
    @Test(groups="1s", timeOut=60000)
    public void testSuccessorsSetChannelingGenerateConstrained() {
        // Generate all solutions
        Model model = new Model();
        int n = 5;
        DirectedGraph LB = GraphFactory.makeStoredDirectedGraph(model, n, setType, setType);
        ...
        while (model.getSolver().solve()) {
            ...
            Assert.assertTrue(g.getValue().getSuccessorsOf(0).contains(3));
            Assert.assertFalse(g.getValue().getSuccessorsOf(0).contains(1));
            Assert.assertTrue(g.getValue().getSuccessorsOf(0).size() > 0
                    && g.getValue().getSuccessorsOf(0).size() <= 3);
        }
        long nbSolutions = model.getSolver().getSolutionCount();
        // Generate without constraint and check
        model = new Model();
        ...
        while (model.getSolver().solve()) {
            if (g.getValue().getNodes().contains(0)
                    && g.getValue().getSuccessorsOf(0).contains(3)
                    && !g.getValue().getSuccessorsOf(0).contains(1)
                    && g.getValue().getSuccessorsOf(0).size() > 0
                    && g.getValue().getSuccessorsOf(0).size() <= 3) {
                count++;
            }
        }
    ...
    public void testSuccessorsBoolChannelingGenerate() {
        ...
        model.successorsChanneling(g, boolVars, 0).post();
        while (model.getSolver().solve()) {
            int[] gNodes = g.getValue().getSuccessorsOf(0).toArray();
    ...
    @Test(groups="1s", timeOut=60000)
    public void testSuccessorsBoolChannelingGenerateConstrained() {
        // Generate all solutions
        Model model = new Model();
        int n = 5;
        DirectedGraph LB = GraphFactory.makeStoredDirectedGraph(model, n, setType, setType);
